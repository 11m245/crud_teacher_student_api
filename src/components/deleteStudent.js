...
function DeleteStudent() {
    ...
    return (<>
        ...
        <form style={{ maxWidth: "600px", marginInline: "auto" }} onSubmit={handleSubmit} className="p-3">
            <h4 className="text-center">Delete Student Details Preview</h4>
            <div className="mb-2">
            ...
            <Button type="submit" color="error" sx={{ width: "150px", display: "block", marginInline: "auto" }} variant="contained">Delete Student</Button>
